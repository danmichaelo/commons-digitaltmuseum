...
( function ( $ ) {
    ...
    function buildDateTable() {
        ...
        for ( var i = 1; i < 13; i++ ) {
            var wgMonthNames = ["", "januar", "februar", "mars", "april", "mai", "juni", "juli", "august", "september", "oktober", "november", "desember"],
                wgMonthNamesShort = ["", "jan", "feb", "mar", "apr", "mai", "jun", "jul", "aug", "sep", "okt", "nov", "des"],
                name = wgMonthNames[i].toLowerCase();
            ts.monthNames[name] = i;
            regex.push( $.escapeRE( name ) );
            name = wgMonthNamesShort[i].toLowerCase().replace( '.', '' );
            ts.monthNames[name] = i;
            regex.push( $.escapeRE( name ) );
        }
